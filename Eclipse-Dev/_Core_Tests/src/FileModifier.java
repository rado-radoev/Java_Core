...
public class FileModifier {
	...
	/**
	 * Method to modify the first string in a method to be the passed changed text
	...
	public void modifyFile(String fileName, String textToChange, String changedText) {
		...
		try {
			...
			// if we get there, we either ran out of lines
			// or we found the text to change
			if (line != null) {
	...
	public static void main(String[] args) {
		...
		String file = "//Users//superlamer//GitHub//Java_Core//Eclipse-Dev//_Core_Tests//src//Cartoon.java";
		fileModifier.modifyFile(file, "Just horsing around", "What's up, Wilbur?");
	}
}
