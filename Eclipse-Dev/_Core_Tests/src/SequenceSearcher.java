...
/**
 * Class that searches a file for a given sequence and reports on the name
 * where that sequenece was found
 * @author superlamer
 *
 */
public class SequenceSearcher {
	...
	public String getNameForSequence(String fileName, String seq) {
		...
		try {
			...
			// loop until the end of file or found a sequence
			...
			// if we get here either end of line or we found the sequence
			if (line != null) {
	...
	public static void main(String[] args) {
		...
		if (name == null) {
			...
			System.out.println("the sequence " + seq + " was found in " + fileName);
		}
	}
