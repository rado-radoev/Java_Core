...
public class Sound extends SimpleSound
{
  ...
  /**
   * Method to make an audio collage. Makes copy of two different sounds
   * and mirrors the first one. Splices together the original souds and the modified sound
   * to make an audio collage. 
   * @param sound1 first sound to splice and mirror
   * @param sound2 second sound to splice
   */
  public static void collage(Sound sound1, Sound sound2) {
	  // temp Sound that will be written to disk
	  Sound temp = 
			  new Sound((sound1.getLength() * 2) + sound2.getLength());
  ...
  /**
   * Method that halves the value of positive values
   * and doubles the value of negative values
   */
